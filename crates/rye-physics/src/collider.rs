...
//!    new [`ColliderKind`].
//!
//! The `Collider::Sphere` variant carries an extra `center: Vec3` field that's unused by
//! physics (the body's position is the center). Construct physics spheres via
