...
//!
//! The core type is [`AssetWatcher`]. Downstream crates (currently `loam-shader`,
//! eventually meshes / textures / scripts) poll it each frame and invalidate their
//! caches on the returned events.
//!
