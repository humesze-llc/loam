...
pub trait RenderNode {
    /// Static label used for tracing / debug output. Returned by reference because most impls
    /// hand back a string literal.
    fn name(&self) -> &'static str;

    /// Run the node against the given device + target view. Errors abort the rest of the graph.
