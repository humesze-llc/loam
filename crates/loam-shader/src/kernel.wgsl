// Geodesic ray march kernel: loam engine WGSL library.
//
// Requires defined earlier in the assembled shader (Space prelude + scene
// module): loam_exp, loam_distance, loam_parallel_transport,
// loam_origin_distance, LOAM_MAX_ARC, loam_scene_sdf.
...
// March a geodesic ray through loam_scene_sdf.
//
...
fn loam_march_geodesic(ro: vec3<f32>, rd: vec3<f32>, ball_scale: f32) -> vec4<f32> {
    ...
    for (var i = 0; i < 256; i = i + 1) {
        ...
        // 40.0 is the Euclidean-equivalent cap; LOAM_MAX_ARC caps Riemannian
...
// `loam_scene_sdf`. The chart-coord gradient is not the Riemannian normal,
