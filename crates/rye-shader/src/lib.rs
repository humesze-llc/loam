...
//! [`rye_math::WgslSpace`]'s `wgsl_impl` is prepended to the user source (and an optional
//! scene module can be inserted between them), so shader authors can call `rye_distance`,
